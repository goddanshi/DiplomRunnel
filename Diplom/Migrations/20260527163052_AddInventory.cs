        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountingVolume = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ActualVolume = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    Difference = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    DifferenceType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Comment = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
